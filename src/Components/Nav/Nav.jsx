    ...
    return(
        <>
            <div className="NavContainer">
                ...
                <a className="NavItem" href="https://www.linkedin.com/in/justin-gracie-6ab58a67/" target="_blank" rel="noreferrer"><img src="../Icons/icons8-linkedin-circled-50.png" alt="Linkedin"/></a>
                <a className="NavItem" href="https://github.com/justingracie" target="_blank" rel="noreferrer"><img src="../Icons/icons8-github-48.png" alt="Linkedin"/></a>
